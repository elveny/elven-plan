...
import site.elven.plan.web.base.SerializableObject;
...
public class BaseResponse extends SerializableObject {
     ...
     * @param resultCode
     *
     * @see BaseResponse#setStatus(site.elven.plan.web.base.response.ResultCodeable)
     */
    @Deprecated
     ...
     * 主要用于判断结果，同 {@link BaseResponse#isResultCodeIn(site.elven.plan.web.base.response.ResultCodeable...)}
     *
